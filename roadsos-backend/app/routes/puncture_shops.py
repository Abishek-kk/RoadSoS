...
router = APIRouter(prefix="/puncture-shops", tags=["Puncture Shops"])


@router.get("")
async def list_puncture_shops(
    lat: float | None = None,
    lng: float | None = None,
    city: str | None = None,
    ...
    """List puncture shops from the verified bundled puncture-shop dataset."""
    service = PunctureShopService()
    if pincode:
