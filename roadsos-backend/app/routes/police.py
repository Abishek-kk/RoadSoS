...
async def list_police(
    ...
    """List police stations from the verified bundled police dataset."""
    ...
    if lat is not None and lng is not None:
        ...
        for result in results:
            result["emergency_call"] = f"tel:{result['emergency_phone']}"
            result["emergency_note"] = "Dial 100 for immediate response."
